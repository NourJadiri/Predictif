...
public class Main {
    ...
    public static void testerAjoutConsultation() {
        ...
        Medium medium4 = new Cartomancien("Cartomancy Reading", "Divination", "A cartomancy reading involves using a deck of cards, such as tarot or oracle cards, to provide insights and guidance.");
